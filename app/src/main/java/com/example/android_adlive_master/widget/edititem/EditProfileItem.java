package com.example.android_adlive_master.widget.edititem;
...
public class EditProfileItem extends FrameLayout {
    ...
    private TextView tv_editprofile_value;
    private ImageView iv_editprofile_avatar;
    private TextView tv_seperater;
    private ImageView iv_right_arraw;
    ...
    //在布局xml中只要使用这个组件就会自动调用这个构造方法创建出来
